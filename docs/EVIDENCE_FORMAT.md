...
```
- **Trigger frame image:** Annotated with metadata text only (Track #, label, timestamps, absence count). No person bbox â€” proves the person was NOT present at trigger time.
