...
<div><h1 class="h4 mb-1" style="font-weight:700;letter-spacing:-.02em">Analysis Report</h1><p class="text-muted mb-0" style="font-size:13px">Correlation <code class="text-mono" style="font-size:11px">{{ $analysisJob->correlation_id ?? "—" }}</code> • Remote <code class="text-mono" style="font-size:11px">{{ $analysisJob->remote_job_id ?? "No remote job" }}</code></p></div>
