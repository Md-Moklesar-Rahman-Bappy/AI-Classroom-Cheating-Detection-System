...
<div class="d-flex justify-content-center align-items-center py-4 py-md-5">
    <div class="card shadow-sm" style="max-width:560px;width:100%;border-radius:16px">
        <div class="card-body p-4 p-md-5 text-center">
            ...
            <div style="font-size:56px;font-weight:700;line-height:1;letter-spacing:-.04em;color:var(--color-text)">419</div>
            <h1 class="h5 fw-semibold mt-2 mb-1">Page Expired — CSRF token expired, please refresh</h1>
            <p class="mb-0" style="font-size:13px;color:var(--color-text-muted);line-height:1.6">Your session has expired or the security token is invalid. This happens after a period of inactivity. Refresh the page and try again — your data has not been lost.</p>
            <div class="d-flex flex-wrap justify-content-center gap-2 mt-4">
                <button type="button" onclick="window.location.reload()" class="btn btn-primary focus-ring" style="font-size:13px"><i class="bi bi-arrow-clockwise me-1" aria-hidden="true"></i> Refresh Page</button>
            ...
            @endif
            <div class="mt-3 p-2 rounded" style="background:var(--color-surface-muted);border:1px solid var(--color-border);font-size:12px;color:var(--color-text-muted);text-align:left"><i class="bi bi-info-circle me-1" aria-hidden="true"></i> Tip: If this repeats, clear cookies or sign in again. Avoid using the back button after long idle periods.</div>
        </div>
    </div>
</div>
@endsection
